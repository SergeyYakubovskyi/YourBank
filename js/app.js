...
*/
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        const loadButton = document.querySelector(".faq__btn-load");
        const faqColumns = document.querySelector(".faq__columns");
        const additionalColumns = document.querySelectorAll(".additional-column");
        if (loadButton && faqColumns && additionalColumns.length > 0) loadButton.addEventListener("click", (() => {
            faqColumns.classList.add("show-cols");
            additionalColumns.forEach((column => {
                column.style.display = "block";
            }));
            loadButton.style.display = "none";
        })); else console.error("One or more FAQ elements not found in the DOM.");
        const logoContainer = document.getElementById("logo-container");
        const isHomePage = window.location.pathname.endsWith("home.html");
        if (logoContainer) if (isHomePage) {
            ...
            } else console.error("Logo link or image not found in the DOM.");
        } else {
            const logoImage = logoContainer.querySelector("img.header__logo");
            if (logoImage) {
            ...
            } else console.error("Logo image not found in the DOM.");
        } else console.error("Logo container not found in the DOM.");
        const currentUrl = window.location.href;
        const menuLinks = document.querySelectorAll(".menu__link");
        if (menuLinks.length > 0) menuLinks.forEach((link => {
            if (link.href === currentUrl) link.classList.add("active-page");
        })); else console.error("Menu links not found in the DOM.");
        const visibilityToggle = document.querySelector(".user-action__see-pass");
        const input = document.querySelector(".input-passwd");
        if (visibilityToggle || input) if (visibilityToggle && input) {
            let password = true;
            visibilityToggle.addEventListener("click", (() => {
                if (password) {
                    input.setAttribute("type", "text");
                    visibilityToggle.classList.add("crossed");
                } else {
                    input.setAttribute("type", "password");
                    visibilityToggle.classList.remove("crossed");
                }
                password = !password;
            }));
        } else {
            if (!visibilityToggle) console.warn("Element with class .user-action__see-pass not found in the DOM.");
            if (!input) console.warn("Element with class .input-passwd not found in the DOM.");
        }
    }));
    document.addEventListener("DOMContentLoaded", (function() {
        gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
        function animateFrom(selector, options) {
            ...
            })); else console.warn(`Element(s) with selector "${selector}" not found in the DOM. This is expected if the current page doesn't contain these elements.`);
        }
        if (document.querySelector(".hero__top")) {
            animateFrom(".hero__top .top__lable", {
                opacity: 0,
                y: -25
            });
            animateFrom(".hero__top .top__title", {
                opacity: 0,
                y: -25,
                delay: .25
            });
            animateFrom(".hero__top .top__text", {
                opacity: 0,
                y: -25,
                delay: .5
            });
            animateFrom(".hero__top .top__btn", {
                opacity: 0,
                y: -25,
                delay: .75
            });
            animateFrom(".hero__image img", {
                opacity: 0,
                x: 25,
                delay: .8
            });
        }
        if (document.querySelector(".products__top")) {
            animateFrom(".products__top .top__title", {
                opacity: 0,
                y: -25
            });
            animateFrom(".products__top .top__text", {
                opacity: 0,
                y: -25,
                delay: .25
            });
            animateFrom(".top__tab-nav", {
                opacity: 0,
                x: 25,
                delay: .5
            });
            animateFrom(".tabs__body .col__body", {
                opacity: 0,
                y: 25,
                delay: .75,
                stagger: .2
        ...
        if (document.querySelector(".cases__top")) {
            animateFrom(".cases__top .top__title", {
                opacity: 0,
                y: -25
            });
            animateFrom(".cases__top .top__text", {
                opacity: 0,
                y: -25,
                delay: .25
            });
            animateFrom(".cases__advantages .advantages__item", {
                opacity: 0,
                y: 25,
                stagger: .2
            });
            animateFrom(".inner__title", {
                opacity: 0,
                y: -25,
                delay: .5
            });
            animateFrom(".inner__text", {
                opacity: 0,
                y: -25,
                delay: .75
            });
            animateFrom(".inner__statistics .statistics__item", {
                opacity: 0,
                y: 25,
                stagger: .2,
                delay: .75
            });
            animateFrom(".inner__btn", {
                opacity: 0,
                y: 25,
                delay: .8
            });
        }
        if (document.querySelector(".vision__top")) {
            animateFrom(".vision__top .top__title", {
                opacity: 0,
                y: 25
            });
            animateFrom(".vision__top .top__text", {
                opacity: 0,
                y: 25,
                delay: .25
            });
        }
        if (document.querySelector(".features__top")) {
            animateFrom(".features__top .features__title", {
                opacity: 0,
                y: -25
            });
            animateFrom(".features__top .features__text", {
                opacity: 0,
                y: -25,
                delay: .25
            });
            animateFrom(".features__tabs", {
                opacity: 0,
                y: 25,
                stagger: .2
            });
            animateFrom(".features__body .col-features__item", {
                opacity: 0,
                y: 25,
                stagger: .2,
                delay: .5
        ...
        if (document.querySelector(".testimonials__top")) {
            animateFrom(".testimonials__top .top__title", {
                opacity: 0,
                y: -25
            });
            animateFrom(".testimonials__top .top__text", {
                opacity: 0,
                y: -25,
                delay: .25
            });
            animateFrom(".testimonials__slide", {
                opacity: 0,
                y: -25,
                stagger: .2
            });
        }
        if (document.querySelector(".financial__top")) {
            animateFrom(".financial__top .top__title", {
                opacity: 0,
                y: -25
            });
            animateFrom(".financial__top .top__text", {
                opacity: 0,
                y: -25,
                delay: .25
            });
            animateFrom(".financial__btn", {
                opacity: 0,
                y: -25,
                delay: .5
            });
        }
        if (document.querySelector(".hero-block__top")) {
            animateFrom(".hero-block__top .top__title", {
                opacity: 0,
                y: -25
            });
            animateFrom(".hero-block__top .top__text", {
                opacity: 0,
                y: -25,
                delay: .25
            });
        }
        if (document.querySelector(".values__top")) {
            animateFrom(".values__top .top__title", {
                opacity: 0,
                y: -25
            });
            animateFrom(".values__top .top__text", {
                opacity: 0,
                y: -25,
                delay: .25
            });
            animateFrom(".block-values__item", {
                opacity: 0,
                y: -25,
                delay: .5,
                stagger: .2
        ...
        if (document.querySelector(".benefits__top")) {
            animateFrom(".benefits__top .top__title", {
                opacity: 0,
                y: -25
            });
            animateFrom(".benefits__top .top__text", {
                opacity: 0,
                y: -25,
                delay: .25
            });
            animateFrom(".benefit-card__body", {
                opacity: 0,
                y: -25,
                delay: .5,
                stagger: .2
        ...
        if (document.querySelector(".job__top")) {
            animateFrom(".job__top .top__title", {
                opacity: 0,
                y: -25
            });
            animateFrom(".job__top .top__text", {
                opacity: 0,
                y: -25,
                delay: .25
            });
            animateFrom(".job__block", {
                opacity: 0,
                y: -25,
                delay: .5,
                stagger: .2
        ...
        if (document.querySelector(".faq__top")) {
            animateFrom(".faq__top .top__title", {
                opacity: 0,
                y: -25
            });
            animateFrom(".faq__top .top__text", {
                opacity: 0,
                y: -25,
                delay: .25
            });
            animateFrom(".faq__columns", {
                scale: .98
            });
        }
        if (document.querySelector(".releases__top")) {
            animateFrom(".releases__top .top__title", {
                opacity: 0,
                y: -25
            });
            animateFrom(".releases__top .top__text", {
                opacity: 0,
                y: -25,
                delay: .25
            });
            animateFrom(".releases__card", {
                opacity: 0,
                y: -25,
                delay: .5,
                stagger: .2
        ...
        if (document.querySelector(".how__top")) {
            animateFrom(".how__top .top__title", {
                opacity: 0,
                y: -25
            });
            animateFrom(".how__top .top__text", {
                opacity: 0,
                y: -25,
                delay: .25
            });
            animateFrom(".how-card__body", {
                opacity: 0,
                y: -25,
                delay: .5,
                stagger: .2
        ...
        if (document.querySelector(".login .top")) {
            animateFrom(".login .top", {
                opacity: 0,
                y: -25
            });
            animateFrom(".user-action__form", {
                opacity: 0,
                y: -25,
                delay: .5,
                stagger: .2
            });
            animateFrom(".user-action__bottom", {
                opacity: 0,
                y: -25,
                delay: .75
            });
